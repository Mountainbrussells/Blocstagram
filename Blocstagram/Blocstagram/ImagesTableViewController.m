...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSString *,id> *)change context:(void *)context
{
    if (object == [DataSource sharedInstance] && [keyPath isEqualToString:@"mediaItems"]) {
        ...
        if (kindOfChange == NSKeyValueChangeSetting) {
            ...
            // #1 - Convert this NSIndexSet to an array of NSindexPaths (which is what the table view animation methods require
            ...
            // #2 - call 'beginUpdates' to tell the table view we are about to make changes
            ...
            // tell the table view we are done telling it about changes, and to complete the animation
...
{
    MediaFullScreenAnimator *animator = [MediaFullScreenAnimator new];
    // Why don't we have to set .presenting to NO?
    animator.cellImageView = self.lastTappedImageView;
    return animator;
}
...
#pragma mark - Camera and Camera View Controller Delegate, and ImageLibraryViewControllerDelegate
...
{
    // Get the fram of the keyboard within self.views coordinate system
    ...
    // Get the framme of the comment view in the same coordinate system
