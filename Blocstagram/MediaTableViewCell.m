...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    self.imageWidthConstraint = [NSLayoutConstraint constraintWithItem:_mediaImageView
                                                             ...
                                                             multiplier:1
                                                               constant:100];
    self.imageHeightConstraint.identifier = @"Image width constraint";
...
- (void) layoutSubviews
{
    ...
    if (self.mediaItem.image.size.height / self.mediaItem.image.size.width * CGRectGetWidth(self.contentView.bounds) <= 100) {
        self.imageHeightConstraint.constant = self.mediaItem.image.size.height / self.mediaItem.image.size.width * CGRectGetWidth(self.contentView.bounds);
    }
    
    if (self.mediaItem.image.size.width <= 100) {
        self.imageWidthConstraint.constant = self.mediaItem.image.size.width;
    }
